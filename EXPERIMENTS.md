...
Baseline **0.4434 / 1.5907 / 0.5236** → champion **E116/fef2779 0.3448 / 1.4721 / 0.5827** (comp **~2.099** mean over 20+ reruns, commit `fef2779`): **ABS_REL −22%, RMSE −7.4%, d1 +5.9 pts**. Champion mean ≈ **2.099±0.008**; individual draws span **2.087–2.114**. Only Δ clearing the noise floor **AND replicated by ≥2 confirmation reruns** is real.

**E116 win:** dropped the vestigial pix2pix encoder tail (24.47→7.69M params, −69%, provably output-equivalent). This is the standing champion.
